(function (window) {
  ...
  let texts = ['KLIK DI MANA AJA :)','PAKAI LANDSCAPE MODE YA', 'HEHE :)', 'HALO REVI', 'TIDAK TERASA YA', 'TAHUN INI', 'UDAH HAMPIR BERAKHIR', 'DI AKHIR TAHUN INI', 'AKU ADA SESUATU UNTUKMU', 'AKU TAHU KAMU PASTI KESAL', 'AKU BENER BENER MINTA MAAF VI','BTW, TERIMA KASIH VI', 'UDAH PERNAH MAU BERBAGI PENGALAMAN', 'AKU BERSYUKUR BISA KENAL KAMU', 'BISA PERNAH DEKAT SAMA KAMU', 'TAPI, SEPERTINYA', 'BELUM SAATNYA', 'EHH...>', 'BTW, SEMANGAT YAA :)', 'AKU TAHU KOK', 'KAMU PASTI BISA VI', 'TAHUN DEPAN', 'BERJUANG SAMA-SAMA', 'HARAPANKU 2025', 'KITA BISA BERBINCANG SEPERTI DULU', 'DENGAN ALMAMATER MASING-MASING', 'I', 'WISH', 'YOU', 'THE BEST', 'AND MAY ALLAH BE WITH YOU', 'AKU RASA CUKUP SEKIAN VI', 'MAAFIN AKU YA', 'PERNAH BUAT KAMU NDAK NYAMAN', 'APABILA KESEMPATAN', 'MEMPERTEMUKAN KITA LAGI', 'AKU TIDAK AKAN LAGI', 'MENYIA-NYIAKAN ITU', 'CLICK TO TEXT ME'];
